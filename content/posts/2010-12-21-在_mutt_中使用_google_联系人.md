...
RT @龍神: <http://piao-tech.blogspot.com/2010/01/google-contacts-in-mutt.html>
...
安装、配置方法在代码开头已经说的很详细了。

打开 Mutt 写一封邮件，在编辑 To: 发件人栏(或 CC/BCC)的时候，和过去一样按 ``<Tab>``
，几乎察觉不到延时，就能看到 GMail 里面的联系人了，还包括了分组信息，很不错。
